...
GOOGLE_MAPS_API_KEY=...
OPENAI_API_KEY=sk-proj-...        # STT (Realtime) + NLU; NO OpenRouter

VOICE_SESSION_STORE=redis
REDIS_URL=redis://127.0.0.1:6379/0
CALL_SESSION_TTL_SEC=7200

# Voice V2 — STT = OpenAI Realtime (gpt-4o-mini-transcribe), usa OPENAI_API_KEY
...
grep "\[stt\]" logs/lyra.log        # openai realtime connected
...
- [ ] Al contestar: log `[transport] stream start` + `[stt] openai realtime connected`
...
- [ ] Límites de concurrencia OpenAI Realtime del plan contratado (audio-tokens)
